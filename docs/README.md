...
This file previously documented `scripts/run_track_tracers.m` as the official
entry point. That script called `track_tracers()`, which never existed in this
repository, and has been deleted. Nothing here described the current pipeline.
