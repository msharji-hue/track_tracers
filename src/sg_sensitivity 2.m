...
% RETIRED with toe_kinematics.m: tunes the SG window that the velocity-first
% chain (kd_kinematics.m) no longer uses. Keep only for the A/B comparison;
% archive to deprecated/ afterward.
%
